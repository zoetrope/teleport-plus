...
type TeleportResourceStatus struct {
...
type TeleportResource struct {
	...
	Spec   TeleportResourceSpec   `json:"spec,omitempty"`
	Status TeleportResourceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// TeleportResourceList contains a list of TeleportResource
type TeleportResourceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []TeleportResource `json:"items"`
}

func init() {
	SchemeBuilder.Register(&TeleportResource{}, &TeleportResourceList{})
}
